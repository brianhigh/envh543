...
results2<-mle(deviance.expntl, start=list(logk=-11), 
	...
	write.csv(EXP_MLE, file="./output/Exponential_MLE_output.csv")
...
resultsbp <- mle(dev.bp,start=list(logalpha=-0.2, logN50=10),
	...
	write.csv(BP_MLE, file="./output/betPoisson_MLE_output.csv")
...
#==================================================================|
write.csv(goodness_fit_results, file="./output/Goodness_Fit_Results.csv")
...
write.csv(best_fitting_model, file="./output/Best_Fitting_Model.csv")
...
#==========histogram of exponential k parameters from the bootstrap==========|
	##pdf(paste("./output/k_parameter_histogram.pdf",sep=''))
	png(paste("./output/k_parameter_histogram.png",sep=''))
...
ndiv <- 700
klist <- exp(bootparms[,1]); write.csv(klist, file="./output/klist.csv")
dmin <- min(dose)/100
ldmin <- log10(dmin)
dmax <- max(dose)*10
ldmax <- log10(dmax)
...
##pdf(paste("./output/Exponential_model_curve.pdf",sep=''))
png(paste("./output/Exponential_model_curve.png", sep=''))
...
write.csv(k_CI, file="./output/k_Confidence_Intervals.csv")
...
write.csv(EID50, file="./output/Exponential_ID50_Confidence_Intervals.csv")
...
#pdf(paste("./output/alpha_N50_plot.pdf",sep=''))
...
##pdf(paste("./output/alpha_N50_plot.pdf",sep=''))
png(paste("./output/alpha_N50_plot.png",sep=''))
##par(cex=1.2,mai=c(1.2,1.2,0.5,0.15),font.lab=1)
...
##pdf(paste("./output/Beta_Poisson_model_curve.pdf",sep=''))
png(paste("./output/Beta_Poisson_model_curve.png", sep=''))
...
write.csv(ealpha_CI, file="./output/alpha_Confidence_Intervals.csv")
print("=========================================================")
...
write.csv(eN50_CI, file="./output/N50_Confidence_Interval.csv")
print("=========================================================")
...
write.csv(dBPID50_CI, file="./output/LD_or_ID50_betaPoisson.csv")
print(dBPID50_CI)
